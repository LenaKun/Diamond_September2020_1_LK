...
namespace CC.Data
{
    public partial class DaysCentersReport
    {
        ...
        public virtual Nullable<decimal> SubsidesByDcc
        {
            get;
            set;
        }
    
        public virtual Nullable<decimal> VisitCost
        {
            get;
            set;
        }
    
        public virtual Nullable<int> VisitsCount
        {
            get;
            set;
        }
        ...
        {
            if (previousValue != null && previousValue.DaysCentersReports.Contains(this))
            {
                previousValue.DaysCentersReports.Remove(this);
            }
    
            if (Client != null)
            {
                if (!Client.DaysCentersReports.Contains(this))
                {
                    Client.DaysCentersReports.Add(this);
                }
        ...
        private void FixupSubReport(SubReport previousValue)
        {
            ...
            if (SubReport != null)
            {
                if (!SubReport.DaysCentersReports.Contains(this))
                {
                    SubReport.DaysCentersReports.Add(this);
                }
