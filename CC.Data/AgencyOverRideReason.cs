...
namespace CC.Data
{
    public partial class AgencyOverRideReason
    {
        ...
        private void FixupCfsRows(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (e.NewItems != null)
            {
                ...
                {
                    if (!item.AgencyOverRideReasons.Contains(this))
                    {
                        item.AgencyOverRideReasons.Add(this);
                    }
                }
            }
            ...
            if (e.OldItems != null)
            {
                foreach (CfsRow item in e.OldItems)
                {
                    if (item.AgencyOverRideReasons.Contains(this))
                    {
                        item.AgencyOverRideReasons.Remove(this);
                    }
                }
            }
        }
