...
namespace CC.Data
{
    public partial class CommunicationsPreference
    {
        ...
        private void FixupClients(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (e.NewItems != null)
            {
                ...
                {
                    item.CommunicationsPreference = this;
                }
            }
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.CommunicationsPreference, this))
                    {
                        item.CommunicationsPreference = null;
                    }
                }
            }
        }
