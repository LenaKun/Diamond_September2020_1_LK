    ...
    public class CcAuthorizeAttributeTest
    {
       ...
       /* class MockDB : ccEntities
        ...
        public void AuthorizeABController()
        {
            ...
            Assert.IsTrue(CcAuthorizeAttributeTest.MethodHasAuthorizeAttribute(exp, new List<FixedRoles>() { FixedRoles.Ser, FixedRoles.Admin, FixedRoles.AgencyUser }));
        ...
        public void AuthorizeMainController()
        {
            ...
            Assert.IsTrue(CcAuthorizeAttributeTest.MethodHasAuthorizeAttribute(exp, new List<FixedRoles>() { FixedRoles.Admin, FixedRoles.GlobalOfficer }));
            ...
            Assert.IsTrue(CcAuthorizeAttributeTest.MethodHasAuthorizeAttribute(exp, new List<FixedRoles>() { FixedRoles.Admin, FixedRoles.GlobalOfficer, FixedRoles.RegionOfficer }));
        ...
        private static bool MethodHasAuthorizeAttribute(Expression<System.Action> expression, List<FixedRoles> lst)
        {
            ...
            foreach (FixedRoles role in lst)
                if (!myAtt.AllowedFixedRoles.Contains(role))
                    return false;
            if(lst.Count != myAtt.AllowedFixedRoles.Count())
                return false;
            return true;
        }
