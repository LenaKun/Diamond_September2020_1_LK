...
namespace CC.Data
{
    public partial class HomeCareEntitledPeriod
    {
        ...
        {
            if (previousValue != null && previousValue.HomeCareEntitledPeriods.Contains(this))
            {
                previousValue.HomeCareEntitledPeriods.Remove(this);
            }
    
            if (User != null)
            {
                if (!User.HomeCareEntitledPeriods.Contains(this))
                {
                    User.HomeCareEntitledPeriods.Add(this);
                }
        ...
        private void FixupClient(Client previousValue)
        {
            ...
            if (Client != null)
            {
                if (!Client.HomeCareEntitledPeriods.Contains(this))
                {
                    Client.HomeCareEntitledPeriods.Add(this);
                }
