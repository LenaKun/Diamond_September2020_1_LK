...
namespace CC.Data
{
    public partial class MhmCap
    {
        ...
        {
            if (previousValue != null && previousValue.MhmCaps.Contains(this))
            {
                previousValue.MhmCaps.Remove(this);
            }
    
            if (Currency != null)
            {
                if (!Currency.MhmCaps.Contains(this))
                {
                    Currency.MhmCaps.Add(this);
                }
        ...
        private void FixupUser(User previousValue)
        {
            ...
            if (User != null)
            {
                if (!User.MhmCaps.Contains(this))
                {
                    User.MhmCaps.Add(this);
                }
        ...
        private void FixupCountries(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (e.NewItems != null)
            {
                ...
                {
                    if (!item.MhmCaps.Contains(this))
                    {
                        item.MhmCaps.Add(this);
                    }
                }
            }
