CREATE FUNCTION [dbo].[GovHcCapLeaveDate]
(
	@clientId int,
...
begin
	...
	begin
		...
		set @curr = (select top 1 GovHcCap from dbo.HcCapsTableWithoutCarry(@start, DATEADD(DAY, 1, @start)) where ClientId = @clientId)
