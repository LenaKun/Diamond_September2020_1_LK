...
namespace CC.Data
{
    partial class MembershipUser
    {
        public void SetPassword(string pass)
        {
            this.Password = PasswordHash.HashPassword(pass);
            this.PasswordSalt = PasswordHash.GetRandomSalt();
        }
        ...
        public bool ValidatePassword(string pass)
        {
			...
			return true;
#endif
			return PasswordHash.ValidatePassword(pass, this.Password);
        }
    }
